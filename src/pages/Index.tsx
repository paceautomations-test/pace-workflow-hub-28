...
const stats = [
  { value: "85%", label: "Average time saved on manual tasks" },
  { value: "48hrs", label: "Typical implementation time" },
  { value: "0", label: "Engineering hires required" },
  { value: "99.9%", label: "Uptime across client workflows" },
];
...
const benefits = [
  {
    ...
    description:
      "Your data stays in your environment. We build on enterprise-grade infrastructure with SOC 2 compliance.",
  },
  {
    icon: Zap,
    title: "Days, Not Months",
    description:
      "Template-driven builds mean common workflows go live in 48-72 hours, not quarters.",
  },
  {
    icon: Clock,
    title: "Time Back for Your Team",
    description:
      "Eliminate 10-20+ hours of manual work per week. Focus on growth, not data entry.",
  },
];
        ...
        <div className="container-wide relative">
          <div className="py-24 md:py-32 lg:py-40">
            ...
            >
              ...
              <motion.h1
                variants={fadeInUp}
                className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-primary-foreground leading-[1.1] mb-6"
              >
                Enterprise automation.{" "}
                <span className="text-gradient-accent">SMB reality.</span>
              </motion.h1>

              <motion.p
                variants={fadeInUp}
                className="text-lg md:text-xl text-primary-foreground/70 max-w-2xl mb-10"
              >
            ...
            >
              <div className="bg-card-gradient rounded-2xl p-8 shadow-prominent">
                <div className="space-y-4">
                  {[
                    { icon: Users, label: "New hire detected in HRIS", status: "complete" },
                    { icon: Layers, label: "Accounts provisioned", status: "complete" },
                    { icon: TrendingUp, label: "Welcome email sent", status: "complete" },
                    { icon: CheckCircle2, label: "Manager notified", status: "active" },
                  ].map((step, index) => (
                    <div
                      key={index}
